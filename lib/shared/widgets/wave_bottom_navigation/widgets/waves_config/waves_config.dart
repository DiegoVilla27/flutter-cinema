...
import 'package:flutter_cinema/shared/widgets/wave_bottom_navigation/widgets/waves_config/waves_paint.dart.dart';
...
class _WaveBottomBarState extends State<WaveBottomBar>
  ...
  void initState() {
    ...
    _animCon = AnimationController(vsync: this)..addListener(() {
      setState(() {});
    });
    ...
    return Positioned(
      ...
      child: GestureDetector(
        ...
        child: SizedBox(
          width: perWidth,
          child:
              hasFixed && widget.fixedWidget != null
